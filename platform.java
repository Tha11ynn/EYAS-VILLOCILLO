...
public class platform extends JPanel implements ActionListener, KeyListener {
    ...
    void startLevel(int lvl) {
        ...
        cannonballs.clear(); particles.clear();
    ...
    void buildLevel2() {
        ...
        // Elevated platforms with hazards
        Platform m1 = addPlatform(350, 350, 110, 15);
        m1.moving = true; m1.mx = 350; m1.mrange = 120; m1.mspeed = 1.5f;
        
        addPlatform(660, 300, 100, 15);
        addSpikes(680, 285, 2, 15); // Spikes on elevated platform
        
        Platform f1 = addPlatform(830, 320, 100, 15);
        f1.fake = true;
        
        Platform b1 = addPlatform(950, 330, 90, 15);
        b1.bouncy = true;
        
        addPlatform(1100, 200, 110, 15);
        
        Platform inv1 = addPlatform(1240, 340, 100, 15);
        inv1.invisible = true;
        ...
        Platform f2 = addPlatform(2140, 310, 90, 15);
        f2.fake = true;
        
        Platform b2 = addPlatform(2350, 330, 90, 15);
        b2.bouncy = true;
    ...
    void buildLevel3() {
        ...
        addSpikes(2915, 245, 2, 15); // Spikes on elevated
        
        // Chasing spike
        addSpikeChasing(300, H-65, 15, 1.8f);
        
        // Ground spikes
        addSpikes(295, H-65, 2, 15);
        addSpikes(565, H-65, 2, 15);
        addSpikes(825, H-65, 2, 15);
        addSpikes(1105, H-65, 2, 15);
        addSpikes(1645, H-65, 2, 15);
        addSpikes(1905, H-65, 2, 15);
        addSpikes(2745, H-65, 2, 15);
        addSpikes(3025, H-65, 2, 15);
    ...
    void buildLevel4() {
        ...
        Platform inv1 = addPlatform(490, 340, 100, 15);
        inv1.invisible = true;
        
        Platform f1 = addPlatform(680, 310, 95, 15);
        f1.fake = true;
        
        addPlatform(870, 290, 100, 15);
        addSpikes(882, 275, 2, 15); // Spikes on elevated
        
        Platform b1 = addPlatform(1000, 330, 90, 15);
        b1.bouncy = true;
        
        addPlatform(1150, 190, 120, 15);
        addSpikes(1165, 175, 3, 15); // More spikes on high platform
        ...
        Platform inv2 = addPlatform(1680, 350, 100, 15);
        inv2.invisible = true;
        
        Platform f2 = addPlatform(1850, 310, 90, 15);
        f2.fake = true;
        
        addPlatform(2040, 280, 100, 15);
        addSpikes(2055, 265, 2, 15); // Spikes on elevated
        
        Platform b2 = addPlatform(2220, 330, 90, 15);
        b2.bouncy = true;
        
        addPlatform(2360, 170, 110, 15);
        addSpikes(2375, 155, 3, 15); // Spikes on high platform
        ...
        Platform inv3 = addPlatform(2900, 330, 100, 15);
        inv3.invisible = true;
        
        addPlatform(3060, 280, 110, 15);
        addSpikes(3075, 265, 2, 15); // Spikes on elevated
        
        Platform b3 = addPlatform(3200, 330, 90, 15);
        b3.bouncy = true;
        
        addPlatform(3350, 160, 120, 15);
        addSpikes(3365, 145, 3, 15); // Spikes on high platform
        ...
        // Ground spikes
        addSpikes(265, H-65, 2, 15);
        addSpikes(525, H-65, 2, 15);
        addSpikes(795, H-65, 2, 15);
        addSpikes(1065, H-65, 2, 15);
        addSpikes(1335, H-65, 2, 15);
        addSpikes(1605, H-65, 2, 15);
        addSpikes(1875, H-65, 2, 15);
        addSpikes(2155, H-65, 2, 15);
...
// ── LEVEL 5 ──────────────────────────────────────────────
    ...
    void buildLevel5() {
        ...
        addSpikes(1210, H-65, 2, 15);
        addSpikes(1770, H-65, 2, 15);
        addSpikes(2050, H-65, 2, 15);
        addSpikes(2610, H-65, 2, 15);
    ...
    void drawTutorialZoneMarkers(Graphics2D g, int cx) {
        String[][] zones = {
            ...
            { "500", "ZONE 2: GAPS" },
            { "1220", "ZONE 3: SPIKES" },
            { "1600", "ZONE 4: FAKE PLATFORMS" },
            { "1960", "ZONE 5: BOUNCY" },
            { "2320", "ZONE 6: MOVING" },
            { "2900", "ZONE 7: INVISIBLE" },
            { "3180", "ZONE 8: CANNONS" },
        };
